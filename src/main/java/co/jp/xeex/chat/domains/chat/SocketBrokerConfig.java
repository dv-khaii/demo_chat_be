...
public class SocketBrokerConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint(ChatEndPoints.CHAT_ROOT_HOST).setAllowedOriginPatterns("*")
                .addInterceptors(tokenHandshakeInterceptor).withSockJS().setSessionCookieNeeded(true);
    }
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        registry.enableSimpleBroker(ChatEndPoints.CHAT_GROUP_SUBSCRIBR, ChatEndPoints.CHAT_USER_SUBSCRIBR,
                ChatEndPoints.CHAT_ALL_SUBSCRIBR, ChatEndPoints.CHAT_PRIVATE_MARK_SUBSCRIBR);
    ...
    public void configureWebSocketTransport(WebSocketTransportRegistration registry) {
         ...
         * afterConnectionEstablished: hold the session of the user this session will be used to close all
         * sessions of a user when user logout
         */
